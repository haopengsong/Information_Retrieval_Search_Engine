...
public class IndexChecker {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            while (itr.hasMoreTokens()) {
                ...
                tokenProcessed = itr.nextToken().trim();
                if (tokenProcessed.equals("architecture") || tokenProcessed.equals("technology") || tokenProcessed.equals("temperature") || tokenProcessed.equals("hierarchy")
                        || tokenProcessed.equals("academics") || tokenProcessed.equals("concurrent") || tokenProcessed.equals("experiment") || tokenProcessed.equals("catalogue")) {
                    word.set(tokenProcessed);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(IndexChecker.class);
