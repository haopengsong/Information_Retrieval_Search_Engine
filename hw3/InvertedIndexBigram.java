...
public class InvertedIndexBigram {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            StringTokenizer itr_fast = new StringTokenizer(contentProcessed);
            itr_fast.nextToken();
            while (itr_fast.hasMoreTokens()) {
                //System.out.println(itr.nextToken());
                tokenProcessed = itr.nextToken();
                tokenProcessed_fast = itr_fast.nextToken();
                /*
                code for bigram
                 */

                tokenProcessed = tokenProcessed + " " + tokenProcessed_fast;
